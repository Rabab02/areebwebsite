...
const routeSEO: RouteSEOConfig = {
  '/': {
    ...
    ar: {
      title: 'أريب تك | شركة تقنية معلومات وحلول ذكاء اصطناعي في الأردن',
      description: 'أريب تك - شركة تقنية معلومات وحلول ذكاء اصطناعي رائدة في الأردن. متخصصة في حلول البرمجيات، Odoo ERP، حلول مركز الاتصال، أنظمة نقاط البيع، والتحول الرقمي. أفضل شركات تقنية المعلومات في الأردن.',
    ...
    en: {
      title: 'Areeb Tech | IT & AI Company in Jordan',
      description: 'Areeb Tech - Leading IT and AI company in Jordan. Specializing in Software Solutions, Odoo ERP, Call Center solutions, Point of Sale (POS) systems, Digital Transformation, and AI-powered technology services. Best IT companies in Jordan.',
  ...
  '/services': {
    ...
    ar: {
      title: 'خدماتنا | أريب تك | شركة تقنية معلومات وحلول ذكاء اصطناعي في الأردن',
    ...
    en: {
      title: 'Our Services | Areeb Tech | IT & AI Company in Jordan',
  ...
  '/privacy-policy': {
    ...
    ar: {
      title: 'سياسة الخصوصية | أريب تك',
      description: 'اقرأ سياسة الخصوصية الخاصة بنا لفهم كيفية جمع أريب تك واستخدامها وحماية معلوماتك الشخصية.',
    },
    en: {
      title: 'Privacy Policy | Areeb Tech',
      description: 'Read our privacy policy to understand how Areeb Tech collects, uses, and protects your personal information.',
    },
  },
  '/terms-of-service': {
    canonicalUrl: 'https://www.areebb.com/terms-of-service',
    ar: {
      title: 'شروط الخدمة | أريب تك',
      description: 'اقرأ شروط الخدمة الخاصة بنا لفهم القواعد والإرشادات لاستخدام خدمات أريب تك وموقعه الإلكتروني.',
    },
    en: {
      title: 'Terms of Service | Areeb Tech',
      description: 'Read our terms of service to understand the rules and guidelines for using Areeb Tech\'s services and website.',
    },
  },
};
